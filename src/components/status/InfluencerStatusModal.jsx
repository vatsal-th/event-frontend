...
import { LuX, LuTriangleAlert, LuDownload, LuGift, LuShare2 } from 'react-icons/lu';
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
            ...
            <div className="relative w-full max-w-[420px] bg-white rounded-[24px] overflow-hidden shadow-[0_20px_60px_rgba(109,40,217,0.2)] border border-purple-100 animate-in zoom-in-95 fade-in duration-300 flex flex-col">
                <div className="flex items-center justify-between px-6 py-5 bg-gradient-to-r from-violet-500 to-purple-600 text-white">
                    <h3 className="text-lg font-black tracking-tight">Influencer Status</h3>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-6">
                    <div className="flex justify-center">
                        <div className="flex items-center space-x-2 bg-amber-50 border border-amber-100 px-4 py-2 rounded-full">
                            <LuTriangleAlert size={16} className="text-amber-600" />
                            <span className="text-gray-600 text-sm font-bold">Influencer Status:</span>
                            <span className="text-amber-600 font-black uppercase text-sm">Pending</span>
                        </div>
                    </div>
