...
const AgencyStatusModal = ({ isOpen, onClose, onClaimReward }) => {
    ...
    const fetchAgencyApplications = async () => {
        try {
            ...
            if (response.success) {
                setApplication(response.data.agency || null);
            } else {
                setError('Failed to load agency applications');
            }
        } catch (err) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-hidden">
            ...
            <div className="relative w-full max-w-[520px] bg-white rounded-[24px] overflow-hidden shadow-[0_20px_60px_rgba(109,40,217,0.2)] border border-purple-100 animate-in zoom-in-95 fade-in duration-300 flex flex-col max-h-[90vh]">
                <div className="flex items-center justify-between px-6 py-5 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white">
                    <h3 className="text-lg font-black tracking-tight">Agency Applications</h3>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-4 overflow-y-auto">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-12">
                            <LuLoader className="animate-spin text-indigo-600 mb-4" size={48} />
                        ...
                        <div className="flex flex-col items-center justify-center py-12">
                            ...
                            <button
                                ...
                                className="px-6 py-2 bg-gradient-to-r from-indigo-600 to-indigo-500 text-white rounded-xl font-bold hover:shadow-lg transition-all cursor-pointer"
                            >
                                Try Again
                            </button>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-12">
                            ...
                            <p className="text-gray-500 text-sm">
                                You haven't submitted any agency applications.
                            </p>
                        </div>
                    ) : (
                        (() => {
                                ...
                                <div className="bg-white rounded-[20px] overflow-hidden border border-gray-100 shadow-sm animate-in slide-in-from-bottom-4 duration-500">
                                    ...
                                    <div className="p-4 space-y-2">
                                        ...
                                        {application.agencyName && (
                                            <div className="flex items-center justify-between py-2 border-b border-gray-50">
                                                <span className="text-gray-500 text-xs font-bold uppercase tracking-wider">Agency Name</span>
                                                <span className="font-bold text-sm text-gray-900">{application.agencyName}</span>
                                            </div>
                                        )}
                                        <div className="flex items-center justify-between py-2 border-b border-gray-50">
                                    ...
                                    {application.status === 'Approved' && !application.isScratched && (
                                        <div className="p-4 border-t border-gray-100">
                                            <div
                                                onClick={() => onClaimReward(application._id, 'agency', application.rewardPoints)}
